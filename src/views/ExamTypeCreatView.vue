    ...
    <v-container fluid>
        ...
        <v-row>
            ...
            <v-col cols="12" class="py-0">
                <v-text-field placeholder="ex)정보처리기사, 리눅스마스터 2급, 등 새롭게 만들 시험" v-model="examSubject"></v-text-field>
            </v-col>
        ...
        <v-row>
            ...
            <v-col cols="12" class="pb-0" style="height: 100%;">
                <v-textarea placeholder="시험 진행 시 안내 및 주의사항 문구를 입력" v-model="examDescription"></v-textarea>
            </v-col>
...
function createEaxmType () {
    ...
    axios.get('/create-examType', {
        params: {
            exam_subject: examSubject.value.trim(),
